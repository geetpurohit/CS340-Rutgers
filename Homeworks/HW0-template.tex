...
\newcommand{\thisheading}{
   ...
   \framebox{
    ...
    \hbox to 6.28in { \textbf{\thiscourse \hfill \thissemester} }
       ...
       \vspace{2mm}
         \hbox to 6.28in { { \hfill Deadline: Tuesday, January 25, 11:59 PM  \hfill} }
       \vspace{2mm}
...
The entire goal of this ``homework'' is to help you get familiar with LaTeX. This homework only has \textbf{bonus credit} for a total of $2\%$ of your  course grade. See your syllabus for more information. 
...
\begin{solution} 
	...
	%=====================================================
	Remove the text below (including the ``\textbackslash text'' command) and instead copy paste the math expression above that is between \$'s. 
	\[
		\text{COPY PASTE HERE} 
	\]
\end{solution}
